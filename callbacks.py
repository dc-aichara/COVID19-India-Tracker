...
help_info = """
    ...
    """
info = html.Div(
    children=[dcc.Markdown(help_info)],  # markdown
    style={"textAlign": "left", "background": "gray"},
)
...
analysis1 = html.Div(
        ...
        html.Div(
            children=[
                html.Div(
                    ...
                    id="rrate",
                    children=[
                        html.H5("Recover Rate", style={"color": "green"}),
                        html.H5(f"{piev[2] / piev[0]:.2%}"),
                        html.Span(
                            f"{ct1:.2%}" + "{}".format("▲" if ct1 > 0 else "▼"),
                ...
                html.Div(
                    ...
                    id="drate",
                    children=[
                        html.H5("Death Rate", style={"color": "red"}),
                        html.H5(f"{piev[3] / piev[0]:.2%}"),
                        html.Span(
                            f"{ct2:.2%}" + "{}".format("▲" if ct2 > 0 else "▼"),
    ...
    className="row-pie",
    style={"background": "#eae2e2", "textAlign": "center"},
)
...
@app.callback(
    ...
    [Input("api-data", "children"), Input("all-tabs-inline", "value")],
)
def render_graph(data, tab):
    ...
    state_data = html.Div(
        className="India-data",
        children=[
            html.Div(
                children=[dcc.Markdown(data_display)],
                className="data-table",
                style={"display": "inline-block"},
            ),
            html.Div(
                children=[dcc.Graph(figure=india_map)],
                className="India-map",
                style={"display": "inline-block", "textAlign": "center"},
            ),
        ],
    ...
    if tab == "tab-1":
                ...
                "data": [
                    {
                        ...
                        "mode": "lines+markers",
                        "marker": {"size": 4, "symbol": "dot", "color": "blue"},
                    },
                    {
                        "x": data["date"],
                        "y": data["confirmed"]
                        ...
                        "name": "Active Cases",
                        "mode": "lines+markers",
                        "marker": {"size": 4, "symbol": "dot", "color": "gray"},
                    },
                    {
                        "x": data["date"],
                        "y": data["recovered"],
                    ...
                    },
                    {
                        ...
                        "name": "Deaths",
                        "mode": "lines+markers",
                        "marker": {"size": 4, "symbol": "dot", "color": "red"},
                    },
                ],
                "layout": {
                    "legend": {"x": 0.10, "y": 0.9},
        ...
        bar_graph2 = dcc.Graph(
            ...
            figure={
                "data": [
                    {
                        "x": df_itvl["interval"],
                        "y": df_itvl["daily_confirmed_cum_sum"]
                        - df_itvl["daily_recovered_cum_sum"]
                        - df_itvl["daily_deaths_cum_sum"],
                        "type": "bar",
                        "name": "Active Cases",
                    },
                    {
                        "x": df_itvl["interval"],
                        "y": df_itvl["daily_recovered_cum_sum"],
                        "type": "bar",
                        "marker": {"color": "green"},
                    ...
                    {
                        "x": df_itvl["interval"],
                        "y": df_itvl["daily_deaths_cum_sum"],
                        "type": "bar",
                        "marker": {"color": "red"},
                        "name": "Deaths Cases",
                    },
        ...
        try:
            ...
            bar = bar[:-1]
            bar["Total"] = (
                bar["Total Confirmed cases"]
                - bar["Cured/Discharged/Migrated"]
                - bar["Death"]
            )
            ...
            bar_graph3 = dcc.Graph(
                ...
                figure={
                    "data": [
                        ...
                        {
                            "y": bar["Name of State / UT"],
                            "x": bar["Cured/Discharged/Migrated"],
                            "type": "bar",
                            "orientation": "h",
                            "marker": {"color": "green"},
                            "name": "Recovered Case",
            ...
            D = html.Div(
                children=[dist_chart],
                className="dist-graph",
                id="dist-graph",
                style={"width": "98%"},
            )
            tab2_display = html.Div(
                children=[A, C, B, D],
                className="tab2-graph",
                id="tab2-graph",
                style={"textAlign": "center"},
            )
